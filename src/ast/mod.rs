...
#[derive(Debug, Clone)]
pub enum BinOp { Add, Sub, Mul, Div, Mod, Pow, IDiv, Eq, Ne, Lt, Le, Gt, Ge, And, Or, NullCoal }

#[derive(Debug, Clone)]
pub enum UnOp  { Neg, Not }

#[derive(Debug, Clone)]
pub struct MatchArm { pub pattern: MatchPat, pub body: Vec<Stmt> }
...
#[derive(Debug, Clone)]
pub enum UnpackItem { Name(String), Rest(String) }
